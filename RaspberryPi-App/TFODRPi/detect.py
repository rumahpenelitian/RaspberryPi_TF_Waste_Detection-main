...
def detect_objects(interpreter, image, threshold):
  ...
  # count = int(len(get_output_tensor(interpreter, 3)))

  boxes = get_output_tensor(interpreter, 1) #TADINYA 0
  classes = get_output_tensor(interpreter, 3) #TADINYA 1
  scores = get_output_tensor(interpreter, 0) #TADINYA 2
  count = int(get_output_tensor(interpreter, 2)) #TADINYA 3
